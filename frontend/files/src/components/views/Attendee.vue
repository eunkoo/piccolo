    ...
    ></v-progress-circular>
        ...
        <v-layout v-if='!printing'    justify-center align-center >
                ...
                <div class="page" >
                    <div class="page-inner">
                        ...
                        <twin-table :isHeader="false"  @changeNoon='changeNoonEx' @changeMorning='changeMorningEx' :tableinfo="'새신자 및 장기 결석'" :attendee1="expectee1" :attendee2="expectee2"></twin-table>
                         <event-notice  v-bind:datas="editedItem"></event-notice>
                       </v-flex>
                    </div>
                </div>
            </div>
         ...
         <event-notice  v-if='printing' @changeNotice='changeNotice'  ref='notice' v-bind:datas="editedItem"></event-notice>
           ...
           <v-flex  :key="8" xs2>
           <v-btn fab @click="print">보기</v-btn>
        </v-flex>
    </v-container>
</template>
      ...
      setInfoText( belong){
          console.log('setInfoText '+belong)
           console.log(this.belong_items[belong].text)
            this.table_info_text=  this.cdateFormat +' '+this.belong_items[belong].text+' '+'출결 - 재적 : '+this.editedItem.totalmember+', 오전 : '+this.editedItem.totalmorning +", 오후 : "+this.editedItem.totalnoon
      },
      changeNotice(notice){

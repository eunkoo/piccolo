    ...
    <v-data-table
      ...
      class="table" >
        ...
        <td class="text-xs-left" style="min-width:100px">{{ props.item.name }}</td>
          <td > <img :src="isMorningAttended(props.item.attended)" width="20px" height="20px" @click="onMorning($event,props.item)"/> </td>
          <td > <img :src="isNoonAttended(props.item.attended)"  width="20px" height="20px" @click="onNoon($event,props.item)"/></td>
          <td> <v-edit-dialog
          ...
          <td > <v-switch @change="closeEdit" v-model="props.item.paragraph"></v-switch></td>
          <td> <v-edit-dialog

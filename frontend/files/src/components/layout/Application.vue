    ...
    <v-app>
      ...
      >
        ...
        <v-menu v-if="!loggedIn" open-on-hover top offset-y>
          ...
          <v-list>
            <v-list-tile :key="items.login.title" @click.stop="dialogLogin = true, error=false">
              <v-list-tile-title v-text="items.login.title"></v-list-tile-title>
            </v-list-tile>
            <v-list-tile :key="items.register.title" @click.stop="dialogRegister = true, error=false">
